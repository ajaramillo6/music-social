        ...
        return (
            <>
                {/* <div className="birthdayContainer">
                        ...
                        <span className="birthdayText"><b>Michael</b> and <b>3 other friends</b> have a birthday today</span>
                    </div>
                    ...
                    {friends.map(friend=>(
                        <Link to={"/profile/"+friend.username} style={{textDecoration:'none'}}>
                            <div className="rightbarFollower">
                                <img src={friend.profilePicture ? PF+friend.profilePicture : PF+"person/no-avatar.jpeg"} alt="" className="rightbarFollowerImg" />
